...
RETURNING id, created, modified, name, url, user_id, last_fetched_at
`
...
select id, created, modified, name, url, user_id, last_fetched_at from feeds order by created desc
`
...
SELECT id, created, modified, name, url, user_id, last_fetched_at FROM feeds ORDER BY last_fetched_at ASC NULLS FIRST limit $1
`
...
update feeds set last_fetched_at = now(), modified=now() where id=$1 RETURNING id, created, modified, name, url, user_id, last_fetched_at
`
